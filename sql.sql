...
status_Post ENUM('published','draft'),
view_count INT,
    category_id  INT,
    user_id INT ,
...
status_com ENUM ('approved', 'pending', 'spam'),
    id_posts  INT,
    user_id INT ,
    FOREIGN KEY (id_posts) REFERENCES post(id_posts ),
    FOREIGN KEY (user_id) REFERENCES users(user_id)
);
...
INSERT INTO post (id_posts, title, content, image_url, created_at_po, updated_at_po, user_id, category_id, status_post, view_count) VALUES
...
INSERT INTO comments (comment_id, author_name, email, content, created_at_com, id_posts, status_com) VALUES
